...
export const TOOLS: ToolEntry[] = [
  {
    ...
    description:
      "Read the contents of a file in the Godot project. Accepts res:// paths or absolute paths.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Write content to a file in the Godot project. Triggers a filesystem scan.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get the current Godot editor state: open scene, selected nodes, play status.",
    inputSchema: {},
    handler: async (client) => {
  ...
  },
  {
    ...
    description:
      "Simulate a keyboard key press in the running Godot game. Key name examples: enter, tab, space, escape, a-z, 0-9, up, down, left, right.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Simulate a mouse click at the given coordinates in the running Godot game. Coordinates are in game viewport space (960x540 default).",
    inputSchema: {
